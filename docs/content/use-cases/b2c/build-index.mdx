...
6. **[Customize the Recovery Email](../build-recovery-email)** tailors the recovery email's content, branding, and languages.
7. **[Onboard Internal Staff](../build-onboarding)** adds staff roles and an invitation flow.
8. **[How It All Runs](../build-run)** traces the finished solution across a single request.
