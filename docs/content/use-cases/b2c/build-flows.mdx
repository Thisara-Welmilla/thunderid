...
The `send_recovery_email` step sends the `PASSWORD_RECOVERY` template. To tailor that email's subject, content, branding, and languages, see [Customize the Recovery Email](../build-recovery-email).
